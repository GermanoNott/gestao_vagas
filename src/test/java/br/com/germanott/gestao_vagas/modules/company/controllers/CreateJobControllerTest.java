...
import br.com.germanott.gestao_vagas.exceptions.CompanyNotFoundException;
...
import br.com.germanott.gestao_vagas.utils.TestUtils;
...
public class CreateJobControllerTest {
    ...
    private MockMvc mvc;
    // MockMvc é uma classe do Spring que permite simular requisições HTTP para
    // testar controladores (controllers) sem precisar iniciar um servidor web
    // completo.
    ...
    @Test
    public void should_be_able_to_cretate_new_job() throws Exception {

        var company = CompanyEntity.builder()
                .description("COMPPANY_DESCRIPTION_TEST")
