...
public class CandidateController {
    ...
    // ResponseEntity<Object> é uma classe do Spring que representa a resposta HTTP
    // que será retornada pelo controlador. Ela encapsula o corpo da resposta,
    // os cabeçalhos e o status HTTP.
    // O tipo genérico Object indica que a resposta pode ser de qualquer tipo.
    // O uso de ResponseEntity<Object> permite que o controlador retorne diferentes
    // tipos de respostas, dependendo do resultado da operação.
    ...
    @Operation(summary = "Perfil do candidato", description = "Essa função é responsavel por retornar o perfil do candidato")
    ...
    @PreAuthorize("hasRole('CANDIDATE')")
    @Operation(summary = "Candidatar-se a uma vaga", description = "Essa função é responsável por candidatar-se a uma vaga")
    @SecurityRequirement(name = "jwt_auth")
